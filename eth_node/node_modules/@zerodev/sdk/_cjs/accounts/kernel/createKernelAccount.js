...
const getKernelInitData = async ({ entryPoint: entryPointAddress, kernelPluginManager, initHook, kernelVersion }) => {
...
const getAccountInitCode = async ({ index, factoryAddress, accountImplementationAddress, metaFactoryAddress, entryPoint: entryPointAddress, kernelPluginManager, initHook, kernelVersion }) => {
...
async function createKernelAccount(client, { plugins, entryPoint: entryPointAddress, index = 0n, factoryAddress: _factoryAddress, accountImplementationAddress: _accountImplementationAddress, metaFactoryAddress: _metaFactoryAddress, deployedAccountAddress, kernelVersion }) {
    const entryPointVersion = (0, permissionless_1.getEntryPointVersion)(entryPointAddress);
    ...
    return {
        ...
        ...(0, accounts_1.toSmartAccount)({
            ...
            async signMessage({ message }) {
                ...
                const { name, chainId, version } = await (0, accountMetadata_js_1.accountMetadata)(client, accountAddress, kernelVersion);
